...
\product[2]{CAM-KP-API (2022-23), a Scala web app for making CAM-KP biomedical pathway information accessible via TRAPI. Now replaced with the ORION pipeline and Plater tool, but source code still available: \github{ExposuresProvider}{cam-kp-api}.}
