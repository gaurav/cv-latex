...
\usepackage[colorlinks=true, urlcolor=blue, linkcolor=black, breaklinks=true]{hyperref}
...
\newcommand{\github}[2]{on GitHub at \href{https://github.com/#1/#2}{{#1}/{#2}}}

\newcommand{\fromto}[2]{{#1} to {#2}}
